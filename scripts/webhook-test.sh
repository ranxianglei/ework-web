...
# ework instance at :1196, then triggers real issue events (create issue,
# comment, close, reopen) and verifies the receiver captured each one with a
# valid Gitea-style signature.
#
# Prereqs:
#   - ework running on :1196 (with WORK_TOKEN env known)
#   - bun on PATH
#
# Usage:
