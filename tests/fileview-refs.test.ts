...
describe("rewriteRelativeMdRefs", () => {
  ...
  test("rewrites non-media link refs to /file browse url", () => {
    const out = rewriteRelativeMdRefs(`[todo](notes/todo.md)`, "/home/dog/p/doc.md");
