...
export function buildSettingsPage(cfg: Config, saved: boolean): { html: string } {
...
<header class="nav"><a href="/" style="color:var(--header-text)">🏠 awork-web</a><span style="opacity:.8"> · 设置</span></header>
<main class="wrap">
<h1>后台配置</h1>
